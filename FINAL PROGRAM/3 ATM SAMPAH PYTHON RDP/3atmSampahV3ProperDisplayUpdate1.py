...
WIRING:
*Raspi
gpio 5 =  [output] ke lampu indikator penuh ----- done
gpio 6 = [input] ke IR sensor, input full, mendapatkan signal jika botol sudah penuh --- done
gpio 13 = [output] ke relay barcode scanner dan conyeyor | buat rescand pin ini diaktifkan lagi --- done
gpio 19 = [output] ke relay untuk output ke arduino = memberikan signal untuk menggerakkan stepper motor jika ada botol masuk | bener atau salah
gpio 26 = [input] ke IR sensor, input bottle, mendapatkan signal jika ada botol masuk --- done
...
- Servo dan stepper motor belum jalan, padahal sudah ada input masuk dari IR 
